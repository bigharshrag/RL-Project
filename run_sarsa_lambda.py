...
def run_sarsa_lamda(args):
    ...
    if args.load_path == None:
        w = SarsaLambda(env, gamma, args.lam, 0.01, X, args.iter, args.verbose)
    ...
    # print("lamdba", args.lam, "Average reward over 100 trials: ", np.mean(Gs))
    # _eval(True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type=str, default='sarsa_lambda.npy')
    ...
    parser.add_argument('--lam', type=float, default=0.98, help="lambda")
